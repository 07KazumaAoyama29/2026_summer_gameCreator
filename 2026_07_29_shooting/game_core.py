...
class App:
    ...
    def update_player(self):
        self.mission["move_player"](self)
        self.mission["shoot_bullet"](self)

    def update_bullets(self):
        self.mission["move_bullets"](self)
        self.clean_bullets()
    ...
    def update_enemies(self):
        ...
        for enemy in self.enemies:
            self.mission["move_enemy"](self, enemy)
    ...
    def check_collisions(self):
        ...
        for bullet in self.bullets:
            ...
            for enemy in self.enemies:
                if self.mission["bullet_hits_enemy"](self, bullet, enemy):
                    hit_bullets.append(bullet)
                    enemy["hp"] -= 1
    ...
    def draw_boss_progress(self):
        ...
        pyxel.text(x + bar_w + 6, y - 1, "REST {:>3}".format(rest_score), 7)
